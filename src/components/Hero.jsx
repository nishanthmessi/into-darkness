    ...
    <>
      <div className="flex flex-col lg:flex-row bg-gray-900 h-screen text-white">
        <div className="flex flex-col justify-center items-center md:w-1/2 p-10">
          <h1 className="text-5xl font-semibold mb-8 text-center">Welcome to Mercury</h1>
        ...
        <div className="md:w-1/2 h-screen flex justify-center items-center">
          <img
            src={HeroImg}
            alt="Hero Image"
            className="h-[40vh] w-[40wh] md:h-[60vh] md:w-[60wh] object-cover animate-[spin_90000ms_linear_infinite]"
          />
        </div>
      </div>
    </>
